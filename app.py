...
def check(email):
    url = "https://mb01e395of.execute-api.us-east-2.amazonaws.com/plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = "https://mb01e395of.execute-api.us-east-2.amazonaws.com/plasma/registration?"+params
...
@app.route('/stats')
def stats():
    url = "https://mb01e395of.execute-api.us-east-2.amazonaws.com/plasma/requestonbloodgroup"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    #print(bloodgrp)
    url = "https://mb01e395of.execute-api.us-east-2.amazonaws.com/plasma/getbloodgroupsdata?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    emailids=[]
    for i in a:
